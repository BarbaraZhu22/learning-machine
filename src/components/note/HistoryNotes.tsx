    ...
    <div className="space-y-2">
      ...
      <div className="grid gap-2">
        {notes.map((note) => (
          <div
            key={note.id}
            className="flex items-center justify-between rounded-md border border-surface-200/40 bg-[color:var(--glass-base)] px-3 py-2 text-sm shadow-sm shadow-primary-100/40 transition hover:-translate-y-0.5 dark:border-surface-700 dark:bg-surface-900"
          >
            <div>
