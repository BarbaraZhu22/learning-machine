    ...
    <div className="space-y-10">
      <section className="app-card p-10">
        <div className="max-w-2xl space-y-5">
          <h1 className="bg-gradient-to-r from-primary-600 via-accent-500 to-primary-800 bg-clip-text text-4xl font-bold leading-tight text-transparent dark:from-primary-200 dark:via-accent-200 dark:to-primary-400">
            {t("appTitle")}
          </h1>
