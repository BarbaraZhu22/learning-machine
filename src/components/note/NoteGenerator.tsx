...
export const NoteGenerator = ({ templates, onGenerate }: NoteGeneratorProps) => {
  ...
  return (
    <div className="space-y-6 rounded-lg border border-surface-200 bg-surface-50 p-4 dark:border-surface-700 dark:bg-surface-950">
      <div className="flex flex-col gap-2">
        <h3 className="text-lg font-semibold">{t('noteGenerator')}</h3>
        <p className="text-sm text-muted-foreground">{aiHints.noteGeneration}</p>
      </div>
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            className="min-h-[160px] rounded-md border border-surface-300 bg-white px-3 py-2 text-sm dark:border-surface-600 dark:bg-surface-900"
      ...
      <div className="space-y-2">
        ...
        <pre className="max-h-72 overflow-auto rounded-md border border-surface-200 bg-white p-4 text-xs dark:border-surface-700 dark:bg-surface-900">
